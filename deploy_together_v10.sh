#!/usr/bin/env bash
# ============================================================
# TREFA — Deploy Together v10 (GPU vast.ai)
#
# Descarga adaptadores LoRA entrenados en Together AI desde HF,
# mergea con modelo base Qwen3-14B, y despliega:
#   vLLM + MCP Server + FastAPI + LiteLLM + Cloudflare Tunnel
#
# NO entrena — solo descarga, mergea y sirve.
#
# Repos HF:
#   Base:      Qwen/Qwen3-14B
#   LoRA:      mmoralesf/qwen3-14B-v10-mariana (Together AI)
#   Merged:    mmoralesf/qwen3-14B-v10-mariana-merged
#
# Puertos:
#   vLLM    → 8001
#   MCP     → 3001
...
#
# Uso:
#   bash deploy_together_v10.sh
#
#   # Si ya tienes el modelo mergeado descargado:
#   bash deploy_together_v10.sh --skip-merge
#
#   # Si ya tienes el modelo mergeado local:
#   bash deploy_together_v10.sh --model-path /app/modelos/mi-modelo
#
#   # Sin tunnel:
#   bash deploy_together_v10.sh --skip-tunnel
# ============================================================
...
HF_LORA_REPO="mmoralesf/qwen3-14B-v10-mariana"
HF_MERGED_REPO="mmoralesf/qwen3-14B-v10-mariana-merged"
SERVED_MODEL="trefa-lora"

BASE_DIR="/app/modelos/qwen3-14b-base"
LORA_DIR="/app/modelos/qwen3-14b-v10-mariana"
MERGED_DIR="/app/modelos/qwen3-14b-v10-merged"
...
log "╔══════════════════════════════════════════════════════════════╗"
log "║       TREFA Mariana v10 — Deploy Together (sin training)     ║"
log "╚══════════════════════════════════════════════════════════════╝"
log ""
log "Config:"
...
log "5d. Iniciando LiteLLM (puerto $LITELLM_PORT)..."
...
log ""
log "╔══════════════════════════════════════════════════════════════╗"
log "║       TREFA Mariana v10 — DEPLOY TOGETHER COMPLETO          ║"
log "╠══════════════════════════════════════════════════════════════╣"
log "║                                                              ║"
